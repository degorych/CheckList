...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sortablejs_Sortable_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sortablejs_Sortable_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_sortablejs_Sortable_js__);
...
var sortable = __WEBPACK_IMPORTED_MODULE_0_sortablejs_Sortable_js___default.a.create(items, {
    ...
    onEnd: function onEnd(evt) {
        ...
        var list = items.querySelectorAll('input[type="hidden"]');

        list = [].concat(_toConsumableArray(list)).filter(function (input) {
